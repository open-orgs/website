 ...
 * signatory-count claim beside it. Nothing here asserts how many organizations have adopted
			...
			<div class="oo-inverse__inner">
				...
				<div class="oo-inverse__side">
					<p class="oo-inverse__body">
						The principles constrain how decisions are routed, how roles are held, and where boundaries close: not what an organization
