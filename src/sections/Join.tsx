 ...
 * favor the other. The header cannot deliver that parity — two solid buttons side by side read
			...
			<div class="oo-join__cards">
				<Card class="oo-join__card">
					...
					<p class="oo-join__card-body">
						Adopt all three principles and record your organization and the date it adopted them. Partial adoption is not listed.
					</p>
				...
				<Card class="oo-join__card">
					...
					<p class="oo-join__card-body">
						A call about what adopting the principles would mean for your organization: where they would bind, and what would have to
