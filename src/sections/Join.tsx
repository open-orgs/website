		...
		<section class="oo-section oo-join" id="join">
			<div class="oo-join__intro">
				...
				<p class="oo-join__lede">
					Adopt the principles and record it, or talk it through first. Neither costs anything, and neither commits
					you to the other.
				</p>
			</div>
			<div class="oo-join__cards">
				<Card class="oo-join__card">
					...
					<p class="oo-join__card-body">
						Adopt all three principles and record your organisation and the date it adopted them. Partial adoption is
						not listed.
					</p>
				...
				<Card class="oo-join__card">
					...
					<p class="oo-join__card-body">
						A call about what adopting the principles would mean for your organisation — where they would bind, and
						what would have to change. No cost, no engagement.
					</p>
