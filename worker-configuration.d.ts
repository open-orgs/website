/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4928fb192d69cfc92a097520c20f07ea)
// Runtime types generated with workerd@1.20260826.1 2026-08-25 global_fetch_strictly_public
interface __BaseEnv_Env {
	DB: D1Database;
	EMAIL: SendEmail;
	SENDER_EMAIL: "hello@openorgs.org";
	ADMIN_EMAIL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SENDER_EMAIL" | "ADMIN_EMAIL" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY">> {}
}
